...
app.get('/status', (_req, res) => res.json({ ok: true, servico: 'cortador', versao: 13, cookies: cookiesOk, proxy: PROXY_URL ? (process.env.PROXY_HOST + ':' + process.env.PROXY_PORT) : false }));
